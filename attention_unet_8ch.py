"""
Attention UNet model with input image with 8 channels.
...
Usage:
    from attention_unet_8ch import AttentionUNet8C
    model = AttentionUNet8C(filters=64, n_block=5, depth=6)
"""
...
class AttentionUNet8C(nn.Module):
    def __init__(self, filters=64, n_block=5, depth=0):
        ...
        self.Convs = [conv_block(8, filters)]
